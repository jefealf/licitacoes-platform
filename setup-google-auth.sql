...
-- NOTA: Para configurar o Google OAuth, você precisa:
-- 1. Ir para Authentication > Providers no painel do Supabase
-- 2. Habilitar Google
...
DO $$
BEGIN
  RAISE NOTICE '✅ Configuração do Google OAuth concluída!';
  RAISE NOTICE '🔧 IMPORTANTE: Configure o Google OAuth no painel do Supabase';
